...
MemeField::MemeField(const Vei2& center, int width_in, int height_in, int nMemes)
	:
...
// this need to change for field ptr
{	

	for (int i = 0; i < numTiles; i++)
		// what is field after i declare it as ptr
	{
		const auto& t = field[i]; // create a reference
